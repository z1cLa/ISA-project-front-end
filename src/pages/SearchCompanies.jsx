...
const SearchCompanies = () => {
    ...
    useEffect(() => {
        ...
        const fetchCompanies = async () => {
          try {
            const response = await fetch("http://localhost:8090/api/v1/company/all");
            if (response.ok) {
      ...
      const handleSearchByName = () => {
        const searchedByName = companyList.filter(
          (company) =>
      ...
      const handleSearchByPlace = () => {
        const searchedByPlace = companyList.filter(
          (company) =>
      ...
      return (
        <div>
          ...
          <div className="search-companies-container">
            ...
            <button className="filter-button" onClick={handleFilterByAverageGrade}>
            Filter
            </button>
            </div>
